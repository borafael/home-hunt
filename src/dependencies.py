...
def get_listing_service(listing_repository: ListingRepository = Depends(get_listing_repository), http_client:HttpClient = Depends(get_http_client)):
    return ListingService(listing_repository, http_client)